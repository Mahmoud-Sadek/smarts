...
// ****************************************************************************
        ...
        public function adress_api($lang)
        {
          ...
          public function add_address_api(Request $request)
          {
                ...
                $address->address_detail_en = $request->input('address_detail');
                ...
                $address->order_id          = $request->input('order_id');
             ...
             if ($result) {
               ...
               public function orders_api()
               {
                   ...
                   if ($order) {
                    ...
                    return  $data = response()->json( ['data' => $order ,
                                                'status' => 'true',
                                               'message' => 'success' ]);
                ...
                // add_review_api ****************************************
                public function add_orders_api(Request $request)
                {
                      ...
                      $datacount = Order::select('id')
                              ->where('user_id', '=', $request->input('user_id') ) ->count();
                ...
                public function orders_product_api()
                {

                    $order_pro = orders_product::select('*')->get();

                    if ($order_pro) {

                     return  $data = response()->json( ['data' => $order_pro ,
                                                 'status' => 'true',
                                                'message' => 'success' ]);
                 ...
                 // add_orders_product_api ****************************************
                 public function add_orders_product_api(Request $request)
                 {

                       $order = new orders_product();
                       $order->id          = $request->input('id');
